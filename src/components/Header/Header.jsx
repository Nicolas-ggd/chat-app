            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <div className="relative">
                        <a href="#" className="flex dark:text-white items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false">
                            Product
                        </a>
                        
                    </div>

                    <Link to="/" className="text-sm dark:text-white font-semibold leading-6 text-gray-900">Features</Link>
                    <a href="#" className="text-sm dark:text-white font-semibold leading-6 text-gray-900">Marketplace</a>
                </div>
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <Link to="/signin" className="text-sm dark:text-white font-semibold leading-6 text-gray-900">Sign In <span aria-hidden="true">&rarr;</span></Link>
                </div>
                <div className="px-5">
                    <Switcher />
                </div>
