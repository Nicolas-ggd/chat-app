...
export const SignUp = ({ closeSignUp }) => {
    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900 transition duration-3s h-screen">
                ...
                <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8 dark:bg-gray-800 dark:rounded-md">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={submitSignUpData}>
                            <div>
                                <label htmlFor="username" className="block mb-2 text-sm font-medium dark:text-white text-gray-900">Your name</label>
                                <input
            ...
            {isSend && <div role="status">
                <div className="flex flex-col items-center justify-center h-screen w-screen">
                    ...
                    <h2 className="p-4 dark:text-white">A verification link has been send to your email.</h2>
                </div>
            </div>}
            {isSuccessSend && !isSend && <div role="status">
                <div className="flex flex-col items-center justify-center h-screen w-screen">
                    <CheckCircleOutlineIcon color="success" fontSize="large"/>
                    <h2 className="p-3 dark:text-white">Please check your email and verify your account.</h2>
                </div>
            </div>}
        </section>
    );
